...
CookieConsent.run({
    ...
    // Die Sprach-Konfiguration
    languages: {
        de: {
            // ===================================================================
            // KORREKTUR: Der gesamte folgende Block ist jetzt in "translations" verschachtelt.
            // Das war der fehlende Teil, der den Fehler verursacht hat.
            // ===================================================================
            translations: {
                consent_modal: {
